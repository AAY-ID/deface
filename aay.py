...
sys.stdout.write('\x1b]2; AAYID DEFACER INDONESIA\x07')
def AAYID(u):
...
def banner():
	cetak(panel(f"""[bold green] 
          ...
          ▐█▌██▐█▌██▌▐▀▐█▌ ▐█▌·▐█▄▄▌  ██. ██ ▐█▄▄▌██ .▐█▪ ▐▌▐███▌▐█▄▄▌
            ▀▀▀▀ ▀▪▀▀▀ ·▀▀▀ ▀▀▀  ▀▀▀   ▀▀▀▀▀•  ▀▀▀ ▀▀▀  ▀  ▀ ·▀▀▀  ▀▀▀   
                          [bold white]𝕄𝕒𝕕𝕖 𝔹𝕪 [bold red]AndreAY [bold blue]ℂ𝕠𝕕𝕖𝕣""",width=100,padding=(0,8),title=f"[bold white]AAYID",style=f"bold green"))
